...
float Floor::get_relative_height(int current_height, int current_width) const {
	int relative_height = this->height_value[current_height][current_width] - this->min_height;
